...
# Each tab groups a different monitoring perspective (overview, gaps, trends, controls).
...
with tab2:
    ...
    # Placeholder distribution used when no persisted breakdown is available yet.
    gap_severity_data = {
        'Critical': 3,
        'High': 8,
        'Medium': 15,
...
with tab3:
    ...
    # Monthly trend scaffold; can be replaced with DB-backed time series later.
