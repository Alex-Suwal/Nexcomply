...
with tab2:
    ...
    # Guard clauses prevent expensive analysis when required inputs are missing.
    ...
    if st.button("Start Analysis", type="primary", use_container_width=True):
        ...
        try:
            # Step 1: Normalize framework data into comparable requirement strings.
...
with tab3:
    ...
    # Filters are applied in sequence: severity first, then optional gap-only view.
