...
with tab1:
    ...
    if 'gap_results' in st.session_state and st.session_state.gap_results:
        ...
        with col2:
            ...
            # Build quick preview metrics from the in-memory analysis result set.
        ...
        if st.button("Generate Report", type="primary", use_container_width=True):
            ...
            try:
                ...
                # Generate each requested format independently to keep partial success possible.
                generated_files = {}
                ...
                # Persist report metadata so it appears in historical reports.
